...
void FLASH_PageWrite(Uint32* pBuffer, Uint32 WriteAddr, Uint16 NumByteToWrite)
{
	...
	{
		NumByteToWrite = W25Q16_PAGE_SIZE;
	}
...
void SPI_FLASH_BufferWrite(Uint32* pBuffer, Uint32 WriteAddr, Uint16 NumByteToWrite)
{
	...
	Addr = WriteAddr / W25Q16_PAGE_SIZE;
	NumOfPage = NumByteToWrite / W25Q16_PAGE_SIZE;
	NumOfSingle = NumByteToWrite % W25Q16_PAGE_SIZE;
	count = W25Q16_PAGE_SIZE - Addr;
	...
	if(Addr == 0)
	{
		...
		else
		{
			while(NumOfPage--)
			{
				FLASH_PageWrite(pBuffer,WriteAddr,W25Q16_PAGE_SIZE);
				pBuffer += W25Q16_PAGE_SIZE;
				WriteAddr += W25Q16_PAGE_SIZE;
			}
